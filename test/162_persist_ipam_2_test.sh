...
assert_raises "timeout 20 cat <( start_container $HOST1 --name=c1 )"
C1=$(container_ip $HOST1 c1)
assert_raises "timeout 20 cat <( start_container $HOST2 --name=c2 )"
...
assert_raises "timeout 20 cat <( start_container $HOST2 --name=c3 )"
...
assert_raises "timeout 20 cat <( start_container $HOST1 --name=c4 )"
